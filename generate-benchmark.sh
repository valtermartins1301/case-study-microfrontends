...
function performance(){
  ...
  lighthouse --chrome-flags="--headless --disable-gpu --no-sandbox" "$URL" --output json --output html --output-path="$DIRNAME/$FILE_NAME" --throttling.cpuSlowdownMultiplier=5 --throttling.throughputKbps=780 --emulated-form-factor=mobile --view
